-- Núcleo Persistente v2 de Aetheria.
-- Idempotente: pode ser executado novamente sem apagar saves ou conteúdo.
USE aetheria_rpg;
...
SELECT 'Núcleo Persistente v2 preparado' AS resultado;
