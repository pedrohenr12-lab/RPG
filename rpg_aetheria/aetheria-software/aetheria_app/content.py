...
REGIONS = {
    ...
    "stonevale": ("Stonevale", "00_despertar_stonevale_platos", "Platôs, cânions e vales-oásis"),
    "blackmarsh": ("Blackmarsh", "00_despertar_blackmarsh_pantanos", "Pântanos, mangues e ilhas errantes"),
    "espinha_do_mundo": ("Espinha do Mundo", "00_despertar_espinha_cordilheira", "Cordilheira monumental, vales profundos e cavernas gigantes"),
}
